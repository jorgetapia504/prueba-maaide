...
export const ProductDetails: React.FC<Props> = ({ product, tempCartProduct, setTempCartProduct }) => {
  ...
  return (
    <div className='fixed bottom-0 flex w-full z-40 p-4'>
      <div className='m-auto p-4 block bg-white shadow-md rounded-md gap-2 w-800 justify-around dark:bg-neutral-900 dark:border dark:border-neutral-800 sm:flex'>
